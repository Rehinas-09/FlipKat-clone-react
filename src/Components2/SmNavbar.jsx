    ...
    <div className='smContainer'>
      <nav className='tvNav'>
        <div className='tvSub'>
          ...
          <a className='pKart'>
            <img className='smflipkartImg' src='https://static-assets-web.flixcart.com/batman-returns/batman-returns/p/images/logo_lite-ea579c.png'/>
          </a>
          <div className='tvApplien'>
              <h1 className='smNavHead'>
                tv and appliences
              </h1>
          </div>
          <a className='smNavSearch'>
      ...
      <div className='sorting-Section'>
          <div className='sm-sort'>
             <div className='sm-filter'>
                <div className='sm-sortedSub'>
                <div className='sm-sort-sub'>
                ...
                <div className='sm-filter-sub'>
                    <div className='sm-filterSub'>
                        <div className='filterSvg'>
      ...
      <div className='sm-boxes'>
        <div className='sm-boxes-sub'>
            <div className='sm-boxes-mid'>
                <div className='sm-boxes-lg'>
                   <div className='sm-boxes-container'>
                    <div className='sp-boxes'>
                        <div className='sp-boxesone'>
                            <div className='sp-boxesone-sub'>
                                <div className='sp-boxesOne'>
                                  <div className='sp-boxesOnesub'>
                                    <img src="https://rukminim1.flixcart.com/www/64/64/promos/21/03/2025/e87c76fe-6dea-4cdb-8453-e53612372d4d.jpg?q=60"></img>
                                  </div>
                                </div>
                                <div className='sp-boxesTwo'>
